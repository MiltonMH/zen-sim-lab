...
export const ROUTINES: RoutineDef[] = [
  {
    key: "pendlare",
    label: "Pendlare (vanlig)",
    description: "Jobbar utanför hemmet, 08–17",
  ...
  },
  {
    key: "hemarbetare",
    label: "Hemarbetare",
    description: "Jobbar hemifrån, bilen hemma hela dagen",
  ...
  {
    key: "deltid",
    label: "Deltidsarbetare",
    description: "Jobbar deltid, kortare bortavaro",
    wake_time: 7, leave_time: 9, return_time: 14, sleep_time: 23,
    badgeClass: "bg-emerald-500/15 text-emerald-700 dark:text-emerald-400 border-transparent",
  },
  {
    key: "pensionar",
    label: "Pensionär / Hemmaboende",
    description: "Mestadels hemma, korta ärenden",
  ...
  {
    key: "skift_tidig",
    label: "Skiftarbete (tidig)",
    description: "Tidigt skift 06–14",
  ...
  {
    key: "skift_sen",
    label: "Skiftarbete (sen)",
    description: "Sent skift 14–22",
