"""
Fetch ALL price areas (SE1, SE2, SE3, SE4) for 2025.
Uses Session + retry logic. Exact same structure as fetch_all_areas_2024.py.
"""
...
OUT_FILE   = Path("data/all_areas_2025.csv")
